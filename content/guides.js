const GUIDE_GROUPS = [
  ...
  },
  {
    ...
    description: 'Guides for resumes, applicant tracking systems, job applications, and career-focused browser workflows.',
  },
];
...
`,
  ...
  },
  {
    ...
    "group": "career",
    "title": "How ATS Systems Actually Work in 2026 (And How to Get Past Them)",
    ...
    "socialDescription": "ATS systems don't reject resumes — they create incomplete database records. Learn the three parsing failure modes, seven formatting rules, and how to close the keyword gap.",
    "teaser": "ATS systems don't reject your resume. They create blank database records that no recruiter ever searches. Understanding the difference changes everything about how you optimize.",
    "published": "2026-06-29",
    "updated": "2026-06-29",
    "readMinutes": 10,
    "tags": ["Resume Builder", "ATS", "Job Search", "Career Tools"],
    "contentHtml": "\n      <div class=\"guide-ats-systems\">\n        <p>By Anurag · June 29, 2026 · ~10 min read</p>\n        <p>Tags: Resume Builder · ATS · Job Search · Career Tools</p>\n        <p>The most common belief about ATS systems is that they scan resumes and automatically reject the ones that fail a keyword test. This is not what happens, and understanding the actual mechanism changes what you need to fix.</p>\n        <p>An Applicant Tracking System is a database with a structured data problem. When you submit a resume through an online portal, the ATS attempts to parse the document into discrete database fields: name, email, phone number, job titles, employer names, employment dates, skills, education. That extracted data becomes a record. Recruiters then search and filter that database — they run queries like \"Python developer, 5+ years, Chicago\" — and the ATS returns the records that match.</p>\n        <p>The problem is not rejection. The problem is incomplete parsing. If the ATS cannot read your skills section, those fields are empty in your database record. If your job titles are unrecognizable, the recruiter's title-based filter never surfaces your application. You are not rejected — you are invisible. No human ever sees the problem because no human is looking at blank records.</p>\n        <p>That distinction matters because it tells you exactly where to focus: you are not trying to satisfy a sophisticated AI judge. You are trying to ensure that a structured data extractor can correctly populate a database record from your document. The problem is mechanical, and the solutions are concrete.</p>\n\n        <div class=\"guide-ats-pipeline\" aria-label=\"ATS parsing pipeline\">\n          <div class=\"guide-ats-flow\">\n            <article><span>📄</span><strong>Resume Upload</strong><p>Your PDF or DOCX enters the system</p></article>\n            <i aria-hidden=\"true\"></i>\n            <article><span>⚙️</span><strong>ATS Parser</strong><p>Extracts text into structured fields</p></article>\n            <i aria-hidden=\"true\"></i>\n            <article><span>🗄️</span><strong>Database Record</strong><p>Name, titles, skills, dates stored as data</p></article>\n            <i aria-hidden=\"true\"></i>\n            <article><span>🔍</span><strong>Recruiter Search</strong><p>Filters and queries surface matching records</p></article>\n          </div>\n          <div class=\"guide-ats-outcomes\">\n            <div class=\"ats-good\"><strong>✅ Fields populated correctly</strong><span>Record surfaces in search → Recruiter sees your resume</span></div>\n            <div class=\"ats-bad\"><strong>❌ Fields empty or garbled</strong><span>Record invisible to search → No human ever sees it</span></div>\n          </div>\n        </div>\n\n        <h2>How ATS Systems Actually Parse Your Resume</h2>\n        <p>The parsing process works differently across platforms — Taleo (Oracle), Greenhouse, Workday, Lever, iCIMS, Bullhorn, and SmartRecruiters each have distinct parsing engines — but three failure modes appear consistently across all of them.</p>\n        <p>Failure mode 1 — Non-extractable text. A resume that looks like a PDF is not always a text-based PDF. Scanned resumes — a physical document photographed and saved as a PDF — contain no readable text at all. The ATS receives the file, attempts to extract text, finds nothing, and creates a blank record. This happens more often than most applicants realize: resumes printed for in-person interviews and then re-scanned, older versions photographed on a phone, or resumes created by screenshotting a design tool output. Always export your resume as a text-based PDF or DOCX where the text can be selected and copied. If you can highlight text in the PDF, the parser can read it.</p>\n        <p>Failure mode 2 — Layout-breaking elements. Two-column layouts, tables, text boxes, and sidebar sections cause most ATS systems to misassign content to the wrong database fields. A skills list placed in a left sidebar may be parsed as part of a work experience entry, or skipped entirely. Contact information placed in a document header section — above the main body — is frequently skipped by ATS parsers because parsers read the body, not the header region. Taleo is particularly aggressive about this; modern systems like Greenhouse handle multi-column layouts better, but since you rarely know which ATS a company uses before applying, single-column layouts are the only safe choice that works across all platforms.</p>\n        <p>Failure mode 3 — Non-standard section headings. ATS systems are trained on standard vocabulary: Work Experience, Education, Skills, Certifications, Summary, Professional Summary. Headings like \"My Story,\" \"What I Bring to the Table,\" \"Career Highlights,\" or \"Where I've Made an Impact\" are frequently unrecognized, and the content beneath them either gets miscategorized or dropped from the record entirely. This is not about creativity — the recruiter reading your resume after it clears ATS will not think less of you for a standard \"Work Experience\" heading. The ATS will misprocess a creative alternative.</p>\n\n        <div class=\"guide-ats-failures\" aria-label=\"Three ATS parsing failure modes\">\n          <article>\n            <div class=\"ats-failure-icon\">🖼️<b>×</b></div>\n            <h3>Non-extractable Text</h3>\n            <div class=\"ats-blur-doc\"><span></span><span></span><span></span><span></span></div>\n            <p class=\"ats-fix\">✅ Fix: Export as text-based PDF or DOCX</p>\n          </article>\n          <article>\n            <div class=\"ats-failure-icon\">📐<b>×</b></div>\n            <h3>Layout-Breaking Elements</h3>\n            <div class=\"ats-layout-sketch\"><div><strong>Skills</strong><span></span><span></span></div><em></em><div><strong>Experience</strong><span></span><span></span></div></div>\n            <p class=\"ats-fix\">✅ Fix: Single-column layout only</p>\n          </article>\n          <article>\n            <div class=\"ats-failure-icon\">🏷️<b>×</b></div>\n            <h3>Non-Standard Headings</h3>\n            <div class=\"ats-heading-demo\"><p class=\"bad\">❌ My Story / Where I've Made Impact</p><p class=\"good\">✅ Work Experience / Education / Skills</p></div>\n            <p class=\"ats-fix\">✅ Fix: Use standard section vocabulary</p>\n          </article>\n        </div>\n\n        <h2>The Keyword Problem: Why \"Team Leadership\" Does Not Equal \"People Management\"</h2>\n        <p>Most major ATS platforms — Taleo, iCIMS, and Greenhouse among them — use exact or near-exact string matching rather than semantic understanding when recruiters search the candidate database. A resume that says \"team leadership\" may not appear when a recruiter searches for \"people management,\" even though any human reader would recognize those as equivalent.</p>\n        <p>This is the keyword gap problem. The job description is the literal answer key. Every required skill, tool name, certification, and responsibility phrase in a job posting is a term the recruiter or search filter will use. If those exact terms are absent from your resume, your record does not surface.</p>\n\n        <div class=\"guide-ats-keywords\" aria-label=\"Keyword gap analyzer example\">\n          <article class=\"ats-job-keywords\">\n            <h3>📋 Job Description Says</h3>\n            <span>Salesforce CRM</span>\n            <span>Google Analytics 4</span>\n            <span>cross-functional collaboration</span>\n            <span>Senior Product Manager</span>\n          </article>\n          <div class=\"ats-keyword-lines\" aria-hidden=\"true\"><span class=\"match\"></span><span class=\"miss\"></span><span class=\"match\"></span><span class=\"miss\"></span></div>\n          <article class=\"ats-resume-keywords\">\n            <h3>📄 Your Resume Says</h3>\n            <span class=\"match\">Salesforce CRM ✅</span>\n            <span class=\"miss\">web analytics ❌</span>\n            <span class=\"match\">cross-functional collaboration ✅</span>\n            <span class=\"miss\">Senior PM ❌</span>\n          </article>\n          <p>2 of 4 keywords matched. 2 gaps need closing.</p>\n        </div>\n\n        <p>Three keyword categories matter differently. Required technical skills and tools — software platforms, programming languages, certifications — must appear verbatim if you have the capability. \"Salesforce CRM\" is not matched by \"CRM tools.\" \"Google Analytics 4\" is not matched by \"web analytics.\" Job title variations are the second category: a posting for \"Senior Product Manager\" may search that exact phrase, and \"Senior PM\" may not trigger the match. Use the exact title variation from the posting in your professional summary when it accurately reflects your experience. Soft skills listed explicitly in the requirements — phrases like \"cross-functional collaboration\" or \"executive stakeholder communication\" — appear in keyword searches on some platforms and should be included where you can support them with evidence in your bullet points.</p>\n        <p>The limit that matters: add keywords only for skills you genuinely have. Keyword matching gets your resume into the recruiter's review queue. The phone screen determines whether those keywords correspond to reality.</p>\n\n        <h2>Seven Formatting Rules That Prevent Parsing Failures</h2>\n        <p>These rules hold across every major ATS platform currently in common use. Following them does not guarantee an interview. Breaking any one of them risks silent invisibility.</p>\n        <p>Rule 1 — Single-column layout only. Every other layout format risks content misassignment during parsing. There are no exceptions to this rule across major platforms.</p>\n        <p>Rule 2 — Standard section headings. Work Experience, Education, Skills, Certifications, Summary. Not creative variants, regardless of how accurate those variants feel to your experience.</p>\n        <p>Rule 3 — Dates in MM/YYYY format. \"03/2022 to 09/2024\" parses universally across all platforms. \"Spring 2022,\" \"Q3 2024,\" and \"Two years\" do not parse reliably and may cause employment dates to be omitted from your database record entirely.</p>\n        <p>Rule 4 — Text-based PDF or DOCX. DOCX parses more reliably than PDF in older Taleo implementations, which still run a significant share of Fortune 500 hiring. When a posting specifies a format, follow it. When either is accepted, DOCX is the safer choice.</p>\n        <p>Rule 5 — No tables, text boxes, or columns. All three cause content to be misread or dropped during parsing, without exception across platforms.</p>\n        <p>Rule 6 — No content in headers or footers. Contact information placed in the document header — the region above the main body in Word or Google Docs — is frequently skipped by ATS parsers. Your name and email may never enter the database.</p>\n        <p>Rule 7 — Standard fonts. Arial, Calibri, Times New Roman, Georgia. Decorative or custom-embedded fonts render as garbled characters or whitespace in some parsing engines.</p>\n\n        <div class=\"guide-ats-rules\" aria-label=\"Seven ATS formatting rules checklist\">\n          <div class=\"ats-rules-head\"><span>#</span><span>Rule</span><span>✅ Safe</span><span>❌ Unsafe</span></div>\n          <article><b>1</b><strong>Single-column layout</strong><span class=\"safe\">One column, top to bottom</span><span class=\"unsafe\">Two columns, sidebar layout</span></article>\n          <article><b>2</b><strong>Standard headings</strong><span class=\"safe\">\"Work Experience\"</span><span class=\"unsafe\">\"My Story\"</span></article>\n          <article><b>3</b><strong>MM/YYYY dates</strong><span class=\"safe\">\"03/2022 – 09/2024\"</span><span class=\"unsafe\">\"Spring 2022\"</span></article>\n          <article><b>4</b><strong>Text-based PDF/DOCX</strong><span class=\"safe\">Selectable text PDF</span><span class=\"unsafe\">Scanned image PDF</span></article>\n          <article><b>5</b><strong>No tables/text boxes</strong><span class=\"safe\">Plain paragraphs + bullets</span><span class=\"unsafe\">Table-formatted resume</span></article>\n          <article><b>6</b><strong>No header/footer content</strong><span class=\"safe\">Contact info in body</span><span class=\"unsafe\">Contact in doc header</span></article>\n          <article><b>7</b><strong>Standard fonts</strong><span class=\"safe\">Arial, Calibri, Georgia</span><span class=\"unsafe\">Decorative, script fonts</span></article>\n        </div>\n\n        <p>Visual design does not matter to an ATS parser. Colorful layouts, custom icons, and design elements that signal effort to a human reviewer are invisible or harmful to a parser. Design matters for the human who reads your resume after it clears ATS processing — not before. The templates in Tooliest's AI Resume Builder use single-column layouts specifically for this reason.</p>\n\n        <h2>What Happens After ATS: The 7-Second Human Review</h2>\n        <p>Clearing ATS parsing is not the finish line. It is the qualifier for the stage where a human actually sees your document.</p>\n        <p>Research from TheLadders using eye-tracking methodology found that recruiters spend an average of 7.4 seconds on initial resume review before deciding whether to continue reading or move to the next candidate. Where their eyes land is consistent:</p>\n        <ul>\n          <li>Name and contact information</li>\n          <li>Most recent job title and employer name</li>\n          <li>Employment dates for the most recent role</li>\n          <li>The first two or three bullet points under the most recent experience</li>\n          <li>Education and graduation year</li>\n        </ul>\n\n        <div class=\"guide-ats-heatmap\" aria-label=\"7.4 second recruiter resume scan heatmap\">\n          <div class=\"ats-time-badge\">7.4 seconds</div>\n          <div class=\"ats-resume-mock\">\n            <section class=\"zone-one\"><strong>Name &amp; Contact</strong><span></span><span></span></section>\n            <section><strong>Summary</strong><span></span><span></span><span></span></section>\n            <section class=\"zone-two\"><strong>Experience #1</strong><span></span><span></span></section>\n            <section class=\"zone-three\"><span></span><span></span><span></span></section>\n            <section class=\"zone-four\"><strong>Experience #2</strong><span></span><span></span><span></span></section>\n            <section class=\"zone-five\"><strong>Education</strong><span></span><span></span></section>\n          </div>\n          <div class=\"ats-heat-labels\">\n            <span>ZONE 1: 🔥 First look</span>\n            <span>ZONE 2: 🔶 Second look</span>\n            <span>ZONE 3: 🟡 Deciding zone</span>\n            <span>ZONE 4: 🔵 Only if interested</span>\n            <span>ZONE 5: ❄️ Rarely reached</span>\n          </div>\n        </div>\n\n        <p>The top third of your resume determines whether a recruiter reads the rest. A professional summary that answers \"who are you professionally, where have you most recently worked, and what did you accomplish there\" in two to three sentences is worth more than three additional bullet points buried in a second-page role from five years ago.</p>\n        <p>Bullet points should describe outcomes, not responsibilities. \"Managed the social media accounts\" describes a task. \"Grew LinkedIn following from 2,400 to 18,000 in 14 months through a weekly editorial calendar focused on case study content\" describes an outcome. Recruiters reading quickly notice the difference immediately.</p>\n\n        <div class=\"guide-ats-transformer\" aria-label=\"Task bullet transformed into outcome bullet\">\n          <article class=\"task\">\n            <h3>❌ Task Description</h3>\n            <p>\"Managed the social media accounts\"</p>\n            <div class=\"ats-meter\"><span></span></div>\n            <small>Tells recruiter: you had this responsibility</small>\n          </article>\n          <span aria-hidden=\"true\">→</span>\n          <article class=\"outcome\">\n            <h3>✅ Outcome Description</h3>\n            <p>\"Grew LinkedIn following from 2,400 to 18,000 in 14 months through a weekly editorial calendar focused on case study content\"</p>\n            <div class=\"ats-meter\"><span></span></div>\n            <small>Tells recruiter: you created this result</small>\n          </article>\n        </div>\n\n        <h2>How to Use the Tooliest ATS Resume Analyzer</h2>\n        <p>Tooliest's AI Resume Builder and ATS Scorer has three modes that address different stages of the application process.</p>\n        <p>ATS Analyzer tab. Paste your resume text and the job description for the role you are applying to. The tool scores your resume 0 to 100 across six dimensions: contact information completeness, section structure and headings, achievement quality in bullet points, keyword density relative to the pasted job description, resume length relative to the optimal range, and overall profile completeness. The score tells you where you stand. More usefully, the breakdown shows which dimension is dragging your total down — a low keyword density score points to keyword gap analysis as the priority; a low achievement quality score means bullet point rewriting will have the most impact before you apply.</p>\n\n        <div class=\"guide-ats-dimensions\" aria-label=\"ATS analyzer scoring dimensions\">\n          <div><p><strong>📋 Contact Information</strong><span>Name, email, phone, LinkedIn</span></p><div class=\"ats-score-bar\"><span></span><b>82</b></div></div>\n          <div><p><strong>🏗️ Section Structure</strong><span>Standard headings, proper ordering</span></p><div class=\"ats-score-bar\"><span></span><b>88</b></div></div>\n          <div><p><strong>🏆 Achievement Quality</strong><span>Outcomes over responsibilities</span></p><div class=\"ats-score-bar\"><span></span><b>74</b></div></div>\n          <div><p><strong>🔑 Keyword Density</strong><span>Match rate vs job description</span></p><div class=\"ats-score-bar\"><span></span><b>61</b></div></div>\n          <div><p><strong>📏 Resume Length</strong><span>Optimal range for experience level</span></p><div class=\"ats-score-bar\"><span></span><b>91</b></div></div>\n          <div><p><strong>👤 Profile Completeness</strong><span>Summary, skills, education coverage</span></p><div class=\"ats-score-bar\"><span></span><b>86</b></div></div>\n          <p><span>🔴 Below 60: Missing sections, weak bullets, or keyword gaps</span><span>🟡 75-89: Structurally sound, adequate coverage</span><span>🟢 90+: Strong alignment with target role</span></p>\n        </div>\n\n        <p>Resume Builder tab. Builds your resume section by section with per-section AI rewrite assistance. Each section has a dedicated rewrite button that improves language and optimization for that section without regenerating the entire document. This lets you preserve sections that are already strong while improving sections that need work.</p>\n        <p>Cover Letter tab. Uses your resume data alongside the company name, role, job description, and any specific company notes you provide to generate a targeted cover letter. Four tone options — Professional, Confident, Conversational, Enthusiastic — and three length settings give you control over the output. The \"Why this company\" field is where meaningful personalization comes from.</p>\n\n        <div class=\"guide-ats-modes\" aria-label=\"Tooliest resume builder modes\">\n          <article class=\"analyzer\"><h3>📊 ATS Analyzer</h3><ul><li>Score 0-100</li><li>6 dimensions</li><li>Keyword density check</li><li>Priority fixes</li></ul><a href=\"/resume-builder/\">Try it →</a></article>\n          <article class=\"builder\"><h3>📝 Resume Builder</h3><ul><li>Section-by-section editing</li><li>Per-section AI rewrite</li><li>Preserve strong sections</li></ul><a href=\"/resume-builder/\">Try it →</a></article>\n          <article class=\"cover\"><h3>✉️ Cover Letter</h3><ul><li>4 tone options</li><li>3 length settings</li><li>Company personalization</li><li>Uses resume data</li></ul><a href=\"/resume-builder/\">Try it →</a></article>\n        </div>\n\n        <p>All processing happens in your browser. Resume data is not stored on Tooliest's servers between sessions.</p>\n      </div>\n",
    "faqs": [
      {
        "q": "Does every company use ATS?",
        "a": "Approximately 99% of Fortune 500 companies and roughly 75% of mid-to-large employers use some form of applicant tracking system. Small companies and early-stage startups with fewer than 50 employees are more likely to receive resumes directly, though many also use lightweight ATS tools or LinkedIn's built-in applicant management. Applying ATS optimization as a default is the safer approach."
      },
      {
        "q": "What is the best file format for submitting a resume?",
        "a": "DOCX is the safest default because it parses more reliably than PDF in older Taleo implementations, which still handle a large share of Fortune 500 hiring. If a job posting specifies PDF, use PDF. If either is accepted, use DOCX. Never submit a resume as a .pages, .odt, or image file — these formats are unsupported by most major ATS platforms and will likely result in a blank or corrupted record."
      },
      {
        "q": "Should a resume be one page or two pages?",
        "a": "One page is appropriate for candidates with fewer than 10 years of directly relevant experience and for recent graduates entering the workforce. Two pages is standard and expected for senior professionals with 10 or more years of directly relevant experience — a one-page resume from a 20-year career signals something was left out, not that the candidate is concise. ATS systems do not penalize multi-page documents at any length."
      },
      {
        "q": "How do I identify which keywords to add?",
        "a": "Read the full job description and note every required skill, tool name, certification, and phrasing used to describe responsibilities. Compare those terms against your resume. Any term present in the job description but absent from your resume is a keyword gap. Add it where it accurately describes your experience and can be supported with specific examples in your bullet points. Tooliest's ATS Analyzer automates this comparison and returns a keyword density score against the pasted job description."
      },
      {
        "q": "What is a good ATS score?",
        "a": "75 to 89 indicates a structurally sound resume with adequate content depth and reasonable keyword coverage — strong enough for most competitive applications. 90 and above indicates strong alignment with the specific job description and well-developed achievement-oriented content. Below 60 almost always means one of three things: missing or incomplete sections, bullet points that list responsibilities without measurable outcomes, or significant keyword gaps between the resume and the target role. The most useful insight is which of the six scoring dimensions is lowest, not the total number."
      },
      {
        "q": "Can I use the same resume for every application?",
        "a": "For applications to the same role type within similar industries, a well-optimized single resume can be effective without modification. For roles with meaningfully different requirements — different industries, different seniority levels, or significantly different skill emphases — the most effective approach is a base resume with a tailored professional summary and adjusted keywords for each application. Tooliest's ATS Analyzer makes this workflow efficient: paste the new job description, review the keyword density score, add the missing terms, and run the analysis again before submitting."
      }
    ],
    "toolLinks": [
      {
        ...
        "description": "Build, score, and optimize your resume for ATS parsing and keyword matching."
      }
    ]
  },
];
