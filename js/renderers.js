...
const TOOL_RENDERER_CHUNKS = {
  ...
  'renderers6.min.js': ['audio-converter', 'invoice-generator', 'email-signature-generator', 'signature-maker'],
  'renderers7.min.js': ['typing-speed-test', 'code-screenshot'],
};
...
const ToolRenderers = {
  ...
  async loadRendererChunk(chunkFile) {
    ...
    const version = typeof TOOLIEST_ASSET_VERSION === 'string' ? TOOLIEST_ASSET_VERSION : '20260426-c40a16bb';
