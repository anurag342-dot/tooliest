// ============================================
// TOOLIEST.COM â€” Tool Registry & Implementations
...
const TOOL_CATEGORIES = [
  { id: 'all', name: 'All Tools', icon: 'ðŸ”¥', count: 0 },
  { id: 'favorites', name: 'Favorites', icon: 'â­', count: 0 },
  { id: 'text', name: 'Text Tools', icon: 'ðŸ“', count: 0 },
  { id: 'seo', name: 'SEO Tools', icon: 'ðŸ”', count: 0 },
  { id: 'css', name: 'CSS Tools', icon: 'ðŸŽ¨', count: 0 },
  { id: 'color', name: 'Color Tools', icon: 'ðŸŒˆ', count: 0 },
  { id: 'image', name: 'Image Tools', icon: 'ðŸ–¼ï¸', count: 0 },
  { id: 'pdf', name: 'PDF Tools', icon: 'ðŸ“„', count: 0, description: 'Merge, split, convert, secure, and enhance PDF files entirely in your browser.' },
  { id: 'json', name: 'JSON Tools', icon: 'ðŸ“‹', count: 0 },
  { id: 'html', name: 'HTML Tools', icon: 'ðŸŒ', count: 0 },
  { id: 'javascript', name: 'JavaScript Tools', icon: 'âš¡', count: 0 },
  { id: 'converter', name: 'Converters', icon: 'ðŸ”„', count: 0 },
  { id: 'encoding', name: 'Encoding Tools', icon: 'ðŸ”', count: 0 },
  { id: 'finance', name: 'Finance Tools', icon: 'ðŸ’°', count: 0 },
  { id: 'math', name: 'Math Tools', icon: 'ðŸ§®', count: 0 },
  { id: 'social', name: 'Social Media', icon: 'ðŸ“±', count: 0 },
  { id: 'privacy-tools', name: 'Privacy Tools', icon: 'ðŸ›¡ï¸', count: 0 },
  { id: 'ai', name: 'AI Tools', icon: 'ðŸ¤–', count: 0 },
  { id: 'developer', name: 'Developer Tools', icon: 'ðŸ’»', count: 0 },
];
...
const TOOLS = [
  // ===== TEXT TOOLS =====
  {
    ...
    whyUse: ['Get instant word, character, sentence, and paragraph counts without uploading files', 'Estimate reading time to improve user engagement and SEO dwell time', 'Check readability scores to ensure your content matches your target audience\'s level', 'Works 100% offline â€” your text never leaves your browser'],
  ...
  },
  {
    ...
    whyUse: ['Clean email lists, CSV data, or log files by removing duplicate entries', 'Sort results alphabetically after deduplication', 'Process sensitive data safely â€” nothing is uploaded'],
  ...
  // ===== SEO TOOLS =====
  {
    ...
    whyUse: ['Generate all essential meta tags in one place â€” title, description, OG, and Twitter Card', 'Preview exactly how your page will appear in Google and social media', 'AI-powered suggestions for SEO-optimized titles and descriptions'],
  ...
  // ===== IMAGE TOOLS =====
  {
    ...
    whyUse: ['Reduce image file sizes by 50-90% without visible quality loss', 'Speed up your website by optimizing images for web delivery', 'Process images locally â€” nothing is uploaded to any server'],
  ...
  },
  {
    ...
    whyUse: ['Resize images to exact pixel dimensions for web, social media, or print', 'Maintain aspect ratio to prevent distortion', 'Process images 100% locally â€” no uploads required'],
  ...
  },
  {
    ...
    whyUse: ['Convert between PNG, JPEG, WebP, and AVIF formats instantly', 'Reduce file sizes by converting to modern formats like WebP and AVIF', 'Process images 100% in your browser â€” no server uploads'],
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>HTML tables and when to use them</strong><br>HTML tables are the correct semantic element for displaying tabular data â€” information with a meaningful row/column relationship. They should <em>not</em> be used for layout (use CSS Grid/Flexbox instead). Accessible tables include <code>&lt;thead&gt;</code>, <code>&lt;th scope="col"&gt;</code>, and a <code>&lt;caption&gt;</code> element for screen-reader clarity.',
    ...
    faq: [
      { q: 'When should I use an HTML table?', a: 'Use HTML tables for tabular data â€” schedules, comparison charts, pricing tables, or data grids. Avoid tables for page layout; use CSS Grid or Flexbox instead. Semantic tables also improve accessibility for screen readers.' }
    ],
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>Why beautify JavaScript?</strong><br>When JavaScript is minified for production, variable names are shortened and whitespace removed â€” making it unreadable for debugging. Running minified code through a beautifier restores indentation and line breaks, making logic readable again. This is essential when debugging vendor scripts, analyzing third-party code, or reviewing source map-less production bundles.',
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>Temperature scales explained</strong><br>There are three main temperature scales: <strong>Celsius (Â°C)</strong> is the metric standard used by most countries, with 0Â° as water\'s freezing point and 100Â° as boiling. <strong>Fahrenheit (Â°F)</strong> is used primarily in the United States, with 32Â° freezing and 212Â° boiling. <strong>Kelvin (K)</strong> is the scientific absolute scale, starting at absolute zero (âˆ’273.15Â°C), and is used in physics, astronomy, and chemistry.',
    whyUse: ['Convert between Celsius, Fahrenheit, and Kelvin instantly', 'See all three scales simultaneously for full context', 'Works offline â€” no network request required'],
    whoUses: 'Students, scientists, travelers, home cooks, and anyone converting temperatures between unit systems.',
    faq: [
      { q: 'What is the formula to convert Celsius to Fahrenheit?', a: 'To convert Celsius to Fahrenheit: Â°F = (Â°C Ã— 9/5) + 32. For example, 100Â°C = (100 Ã— 1.8) + 32 = 212Â°F. To convert back: Â°C = (Â°F âˆ’ 32) Ã— 5/9.' }
    ],
  ...
  },
  {
    ...
    faq: [
      { q: 'What is hexadecimal used for in programming?', a: 'Hexadecimal (base 16) is used for memory addresses, color codes (e.g. #FF5733 in CSS), machine code, and binary data representation. It is more compact than binary â€” one hex digit represents exactly 4 binary bits.' }
    ],
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>Understanding time zones</strong><br>Time zones offset from Coordinated Universal Time (UTC), the world\'s primary time standard. UTC+0 is Greenwich Mean Time (GMT). The United States uses UTCâˆ’5 (EST) to UTCâˆ’8 (PST). India uses UTC+5:30 (IST), a non-standard 30-minute offset. Some regions also observe Daylight Saving Time (DST), adding an hour during summer months.',
  ...
  },
  {
    ...
    whyUse: ['Generate MD5, SHA-1, SHA-256, and SHA-512 hashes from any text', 'Verify file integrity by comparing hash values', 'All hashing is done locally â€” your data never leaves your browser'],
  ...
  // ===== MATH TOOLS =====
  {
    ...
    isAI: false,
    education: '<strong>Percentage calculations explained</strong><br>Percentages express a fraction of 100. Three common calculations: "What is X% of Y?" (X/100 Ã— Y), "X is what % of Y?" (X/Y Ã— 100), and "percentage change" ((New-Old)/Old Ã— 100). This tool handles all three types with clear input fields and instant results.',
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>Understanding BMI and its limitations</strong><br>Body Mass Index (BMI) is calculated as weight (kg) Ã· heightÂ² (mÂ²). The WHO classifies results as: Underweight (&lt;18.5), Normal (18.5â€“24.9), Overweight (25â€“29.9), and Obese (â‰¥30). BMI is a useful screening tool but has known limitations â€” it does not directly measure body fat and can misclassify muscular individuals as overweight.',
    ...
    faq: [
      { q: 'What is a healthy BMI range?', a: 'According to the WHO, a BMI between 18.5 and 24.9 is considered "normal weight." Below 18.5 is underweight, 25â€“29.9 is overweight, and 30 or above is classified as obese. BMI is a population-level screening metric and should be interpreted alongside other health indicators.' }
    ],
...

  {
    ...
    isAI: false,
    education: '<strong>Tipping customs around the world</strong><br>Tipping norms vary significantly by country. In the United States, 15â€“20% is standard for restaurants. In the UK, 10â€“12.5% is common. In Japan and South Korea, tipping is often considered rude. This calculator handles any tip percentage, splits the bill evenly or by custom amounts, and shows per-person totals including the tip.',
    ...
    faq: [
      { q: 'How much should I tip at a restaurant?', a: 'In the United States, 15% is the minimum for adequate service, 18â€“20% is standard for good service, and 20%+ is for exceptional service. For a $50 bill: 15% = $7.50, 18% = $9.00, 20% = $10.00.' }
    ],
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>What makes a great Instagram caption?</strong><br>Top-performing Instagram captions typically open with a hook (a question or surprising fact) within the first 125 characters â€” since only those characters show without tapping "More." They end with a clear call-to-action (like, comment, follow, link in bio) and include 3â€“5 relevant hashtags. Emojis add visual personality and increase engagement rates by up to 15%.',
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>Hashtag strategy for social media reach</strong><br>Hashtags categorize content and make it discoverable to users following specific topics. On Instagram, the sweet spot is 5â€“10 highly relevant hashtags â€” not the maximum 30 (which signals spam). On TikTok, 3â€“5 niche hashtags outperform broad ones. On LinkedIn, 3â€“5 professional hashtags are effective. Mix broad (#marketing) with niche (#emailmarketingtips) to balance reach and targeting.',
    ...
    faq: [
      { q: 'How many hashtags should I use on Instagram?', a: 'Instagram\'s own research and creator accounts suggest 3â€“10 highly relevant hashtags perform better than 30 generic ones. Focus on hashtags with 10Kâ€“1M posts for the best balance of discoverability and competition. Avoid banned or overused hashtags.' }
    ],
  ...
  },
  {
    ...
    faq: [
      { q: 'What is the ideal YouTube thumbnail size?', a: 'YouTube recommends 1280Ã—720 pixels with a 16:9 aspect ratio, under 2MB in JPG, GIF, or PNG format. Always check how it looks at the small card thumbnail size (320Ã—180) â€” text must remain readable at that scale.' }
    ],
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>What is a UUID?</strong><br>UUID (Universally Unique Identifier) is a 128-bit identifier standardized by RFC 4122. Version 4 UUIDs are randomly generated and have a collision probability so low it is statistically negligible (1 in 5.3Ã—10Â³Â¶ per generated pair). UUIDs are used as primary keys in databases, session tokens, transaction IDs, and anywhere a unique identifier is needed without a central registry.',
    ...
    faq: [
      { q: 'What is the difference between UUID v1 and UUID v4?', a: 'UUID v1 is generated from the current timestamp and MAC address â€” it is time-based and can expose when and where it was created. UUID v4 is randomly generated with no traceable information. Use v4 for general-purpose identifiers and v1 only when time-ordering is specifically required.' }
    ],
  ...
  },
  {
    ...
    isAI: false,
    education: '<strong>Why use fake data for testing?</strong><br>Using real user data in development and testing environments is a major GDPR and HIPAA compliance risk. Realistic fake (synthetic) data â€” with valid-looking names, emails, phone numbers, addresses, and credit card numbers â€” lets you build and test features without exposing real user information. All data generated by this tool is completely fictional.',
  ...
  },
  {
    ...
    whyUse: ['Remove GPS coordinates and location data from photos before sharing', 'Strip camera brand/model, date, and device information for privacy', '100% offline processing â€” your photos never leave your browser'],
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>The anatomy of an effective professional email</strong><br>Professional emails follow a clear structure: a specific subject line (not "Hello"), a personalized opener, a concise body with one clear purpose per email, and a specific call-to-action. The average professional receives 121 emails per day â€” getting to the point quickly and using a clear subject line are the two highest-impact improvements.',
    ...
    faq: [
      { q: 'How do I write a professional email?', a: 'A strong professional email has: (1) a specific subject line summarizing the request, (2) a greeting with the recipient\'s name, (3) a brief opening that states your purpose, (4) a concise body â€” 3â€“4 sentences maximum, (5) a clear call-to-action, and (6) a professional sign-off like "Best regards" or "Sincerely."' }
    ],
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>What is a meta description and why does it matter?</strong><br>A meta description is the 150â€“160 character summary shown below your page title in Google search results. While it is not a direct ranking factor, it strongly influences click-through rate (CTR). A compelling meta description with the target keyword and a clear value proposition can improve CTR by 5â€“10%, effectively increasing your traffic without changing your ranking position.',
    whyUse: ['Generate compelling meta descriptions that improve search click-through rates', 'Ensure descriptions stay within the 150â€“160 character Google limit', 'Include primary keywords naturally for both SEO and user relevance'],
    ...
    faq: [
      { q: 'How long should a meta description be?', a: 'Google typically displays meta descriptions up to 155â€“160 characters on desktop and around 120 characters on mobile. Write descriptions that are 140â€“155 characters to stay within limits on both devices. Include your primary keyword and a clear call-to-action ("Learn how," "Get started," "Try free").' }
    ],
  ...
  },
  {
    ...
    customSections: [
      ...
      {
        heading: 'SVG vs PNG â€” Which Export Format Should You Use?',
        body: [
    ...
    meta: { title: 'Code Screenshot Generator â€” Beautiful Code Images, Offline-Ready | Tooliest', desc: 'Create stunning syntax-highlighted code screenshots in seconds. 20+ themes, 20+ languages, custom fonts, window chrome, gradient backgrounds. Download as PNG or SVG. Your code never leaves your browser â€” works offline too.' },
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>Return on Investment (ROI) explained</strong><br>ROI measures the profitability of an investment relative to its cost. The formula is ROI = (Net Profit Ã· Cost of Investment) Ã— 100. For example, investing $10,000 and receiving $13,000 back gives ROI = (3,000 Ã· 10,000) Ã— 100 = 30%. Annualized ROI adjusts for time, enabling fair comparison between investments held for different durations.',
    ...
    faq: [
      { q: 'What is a good ROI?', a: 'A "good" ROI depends on the investment type and risk level. The S\u0026P 500 averages ~10% annually (historical). Real estate averages 8â€“12% including appreciation. Marketing campaigns targeting 300â€“500% ROI on ad spend. For individual stock picks, beating the S\u0026P 500 index is considered outperformance.' }
    ],
  ...
  },
  {
    ...
    isAI: true,
    education: '<strong>Snowball vs. Avalanche debt payoff methods</strong><br>The <strong>Debt Snowball</strong> method pays off the smallest debt first, then rolls that payment to the next â€” creating psychological momentum. The <strong>Debt Avalanche</strong> method pays the highest-interest debt first, minimizing total interest paid mathematically. Avalanche saves more money; Snowball is better for motivation. This calculator shows both strategies with a timeline and total interest comparison.',
  ...
  },
  {
    ...
    customSections: [
      ...
      {
        heading: 'Invoice Generator vs. Invoicing Software â€” What\'s the Difference?',
        body: [
    ...
    meta: { title: 'Free Invoice Generator â€” Create & Download Invoices Instantly | Tooliest', desc: 'Generate professional invoices in seconds. Add your logo, line items, tax rates, and custom notes. Download as PDF instantly. 100% free, no signup, works offline.' }
  },
  {
  ...
  // ===== AUDIO TOOLS =====
  {
    ...
    description: 'Convert MP3, WAV, FLAC, M4A, OGG, OPUS, WMA and more â€” entirely in your browser. No uploads, 100% private.',
    category: 'converter',
    icon: 'ðŸŽµ',
...

  {
    ...
    isAI: true,
    education: '<strong>How inflation erodes purchasing power</strong><br>Inflation is the rate at which prices rise over time, measured by the Consumer Price Index (CPI). At 3% annual inflation, $100 today will only buy $74 worth of goods in 10 years. This is why investing is necessary to preserve wealth â€” savings accounts earning below the inflation rate lose purchasing power in real terms. Central banks target 2% inflation as the optimal balance between growth and stability.',
    ...
    faq: [
      { q: 'What is the current inflation rate?', a: 'Inflation rates change frequently. In the United States, the Federal Reserve targets a 2% annual inflation rate. From 2021â€“2023, the US experienced peak inflation of 8â€“9% (the highest since the 1980s) before cooling back toward the 2â€“3% range. Check the US Bureau of Labor Statistics (BLS) for the most current CPI data.' }
    ],
...
const TOOLIEST_SEO_OVERRIDES = {
  ...
  'character-counter': {
    ...
    howToSteps: [
      ...
      { name: 'Check characters with and without spaces', text: 'Compare both counts â€” some platforms like Twitter count spaces, while others like SMS character limits may not.' },
    ...
    customSections: [
      {
        ...
        body: [
          'Double-check line items, payment terms, tax handling, due dates, and contact details before exporting the final invoice. Small inconsistencies can slow payment more than people expect, especially when a clientâ€™s finance team has to reconcile the document manually.',
        ],
      },
    ],
    faqExtras: [
...
function buildTooliestMetaLead(tool) {
  ...
  // Use the tool's own description as the lead â€” it's already human-written and unique
